...
export function Button({
  ...
  return (
    <button
      type={type}
      className={j(
        "flex w-full flex-grow select-none items-center justify-center rounded-lg border px-4 py-2 font-medium shadow-sm transition-all focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 focus-visible:ring-offset-base-50 dark:focus-visible:ring-offset-base-dark-950",
        primary
